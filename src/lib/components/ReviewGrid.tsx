...
export const ReviewGrid: React.FC<ReviewGridProps> = ({ 
  ...
  return (
    <div className={`w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 ${isDark ? 'bg-gray-900' : ''}`}>
      <h2 className={`text-2xl font-bold mb-8 text-center ${textColor}`}>What our customers say</h2>
